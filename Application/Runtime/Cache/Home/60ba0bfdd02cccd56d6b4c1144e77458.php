...
<head>
    ...
    <style>
        body{
            background : url("/Application/Home/View/img/weibo_bg.jpg");
        }
        .info{
            width: 800px;
            height: 140px;
        ...
        .error{
            background: url("/Application/Home/View/img/jump_error.png") no-repeat;
        }
        .success{
            background: url("/Application/Home/View/img/jump_success.png") no-repeat;
        }
        .jump{
            color: #666;
